...
pytest                                  # 628 tests, ~25s, no network
...
| Module | Role |
|---|---|
| [`fencing.py`](src/waypoint/fencing.py) | The turn fence. Pure, no dependencies, 112 of the 628 tests. |
...
| Test suite | `pytest` | no | 628 passing |
...
has. All 628 tests, all six acceptance scenarios and the first harness's 15/15
