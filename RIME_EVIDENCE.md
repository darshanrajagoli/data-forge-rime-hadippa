...
| `test_check_docs.py` | 55 | that the documentation still matches the repository |
...
"628 tests pass" is not evidence. A suite that stays green when you break the
