...
| `test_check_docs.py` | 47 | that the documentation still matches the repository |
...
"620 tests pass" is not evidence. A suite that stays green when you break the
