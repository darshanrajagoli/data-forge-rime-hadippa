...
| `test_check_docs.py` | 59 | that the documentation still matches the repository |
...
"632 tests pass" is not evidence. A suite that stays green when you break the
